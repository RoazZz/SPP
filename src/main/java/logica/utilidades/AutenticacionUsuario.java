...
public class AutenticacionUsuario {
    ...
    public UsuarioDTO autenticar(String Usuario, String contrasenia) throws DAOExcepcion, EntidadNoEncontradaExcepcion, AutenticacionDeUsuarioExcepcion {
        ...
        if (!verificarContrasenia(contrasenia, usuario.getContrasenia())) {
            REGISTRADOR.log(Level.WARNING, "Intento de inicio de sesión fallido para el usuario: ", Usuario);
            throw new AutenticacionDeUsuarioExcepcion("La contraseña ingresada es incorrecta.");
        }

        REGISTRADOR.log(Level.INFO, "Usuario autenticado exitosamente: {0}", Usuario);
        return usuario;
    }
    ...
    private UsuarioDTO buscarUsuario(String usuario) throws DAOExcepcion, EntidadNoEncontradaExcepcion {
        ...
        try {
            ...
            REGISTRADOR.log(Level.INFO, "El usuario no es un practicante");
        } catch (DAOExcepcion e) {
            REGISTRADOR.log(Level.SEVERE, "Error al buscar practicante", e);
        ...
        try {
            ...
            REGISTRADOR.log(Level.INFO, "El usuario no es un profesor");
        } catch (DAOExcepcion e) {
            REGISTRADOR.log(Level.SEVERE, "Error al buscar profesor", e);
        ...
        try {
            ...
            REGISTRADOR.log(Level.INFO, "No es coordinador");
        } catch (DAOExcepcion e) {
            REGISTRADOR.log(Level.SEVERE, "Error al buscar coordinador", e);
        ...
        REGISTRADOR.log(Level.INFO, "No se encontro ningún usuario");
